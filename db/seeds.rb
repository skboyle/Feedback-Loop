...
feedback_list = [
  ...
  { structure: "Sounds nice, Could use more improvisation.",
    mixdown: "I'm not hearing the mids. Try referencing against a song you like.",
    style: "Drums are a little stiff for me. Try using breaks like in the song I'm recomending.",
    recomendations: "spotify:track:6M5hvy4gXgBsBwHRImZ8xb",
    user_id: user3.id,
    song_id: song7.id
  },
  { structure: "Intro is too long.",
    mixdown: "Snare is a little soft. Some of the delayed/filted noises in the middle are too loud.",
    style: "I would tighten up the hats.",
    recomendations: "spotify:track:61KDxXsE0axAXmB9o7lFpt",
    user_id: user7.id,
    song_id: song6.id
  },
  { structure: "Nice a dreamy",
    mixdown: "Bass is a little muddy and the kick is weak.",
    style: "I think it could use some more syncopation",
    recomendations: "spotify:track:55deWd6A7q4dsrByCai4wf",
    user_id: user6.id,
    song_id: song5.id
  },
  { structure: "This is rad. I don't like the aburpt ending though.",
    mixdown: "Sounds good overall. The hats an be a little loud.",
    style: "Great style. super rugged.",
    recomendations: "spotify:track:6H0KRotbTYPOwpPA9PBCrz",
    user_id: user5.id,
    song_id: song4.id
  },
  { structure: "No complaints",
    mixdown: "Work on the low end mixing",
    style: "I like the 90s horn stab.",
    recomendations: "spotify:track:3VVDsziaVH0QTRewvaxiKV",
    user_id: user4.id,
    song_id: song3.id
  },
  { structure: "Nice build. I like the reverb/delay fade out.",
    mixdown: "Sounds great.",
    style: "I could maybe go for some more textures, rather than all synths.",
    recomendations: "spotify:track:03AmgIKqjLdkkHzXF2iQoz",
    user_id: user3.id,
    song_id: song2.id
  },
  { structure: "Cool track, I liked the filter and drop.",
    mixdown: "Sounds pretty solid.",
    style: "I could change up the bass line.",
    recomendations: "spotify:track:6J3aUG1y0zSJXOnsLhx41h",
    user_id: user2.id,
    song_id: song1.id
  }
]
